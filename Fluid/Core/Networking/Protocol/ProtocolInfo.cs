...
namespace Fluid.Core
{
    public partial class Network
    {
        public static class ProtocolInfo
        {
            ...
            */
            public static int CURRENT_PROTOCOL = int.Parse("201"); //plugins can change it

            private static List<int> SUPPORTED_PROTOCOLS = new List<int>()
            {
                CURRENT_PROTOCOL
            };

            public static readonly String MINECRAFT_VERSION = "v1.2.10";
            public static readonly String MINECRAFT_VERSION_NETWORK = "1.2.10";
