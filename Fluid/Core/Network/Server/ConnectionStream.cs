...
namespace Fluid.Core
{
    ...
    {
        public delegate void PacketHandler(ClientSyn client, ConnectionStream server, IPacket packet);
        ...
        public List<ClientSyn> Clients { get; set; }
